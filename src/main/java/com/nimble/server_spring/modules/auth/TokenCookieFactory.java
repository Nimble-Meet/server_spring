...
public class TokenCookieFactory {
    ...
    public Cookie createAccessTokenCookie(String tokenValue) {
        Cookie cookie = new Cookie(ACCESS_TOKEN_COOKIE_KEY, tokenValue);
        cookie.setPath("/");
    ...
    public Cookie createRefreshTokenCookie(String tokenValue) {
        Cookie cookie = new Cookie(REFRESH_TOKEN_COOKIE_KEY, tokenValue);
        cookie.setPath("/");
    ...
    public Cookie createExpiredAccessTokenCookie() {
        Cookie cookie = new Cookie(ACCESS_TOKEN_COOKIE_KEY, "");
        cookie.setPath("/");
        cookie.setMaxAge(0);
        cookie.setHttpOnly(false);
